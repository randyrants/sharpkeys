...
namespace SharpKeys
{
    ...
    private void SaveMappingsToRegistry() {
      Debug.Assert(Utilities.IsAdmin, "Use should not reach here if app was not launched as admin");
    ...
    private void Dialog_Main_Load(object sender, System.EventArgs e) {
      ...
      btnSave.Enabled = Utilities.IsAdmin;
    }
