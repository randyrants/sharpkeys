...
* Click "Write to registry" and wait for a confirmation that the registry was successfully updated, and...
...
* Force you to look for the Left or Right ALT key in the list of available keys because Type Key cannot scan for ALT, and...
...
* Support multiple mappings for different users - the Windows key being tweaked is for an entire machine, or...
...
* An import/export functionality that allows people to swap keymappings easier, and...
